...
# The name of a Pygments style to use for syntax highlighting:  xcode, fruity,
# paraiso-dark, algol_nu, igor, emacs, colorful, vs, algol, tango, perldoc,
# trac, native, autumn, lovelace, rrt, borland, default, bw, vim, paraiso-light,
# manni, pastie, friendly, monokai, murphy
